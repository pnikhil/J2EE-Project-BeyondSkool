...
loginModule.controller('loginController', function($scope, $state, $rootScope, $window, $location,toaster,
		$localStorage, AuthenticationService) {
			...
			$rootScope.isParentLoggedIn = false;
			$rootScope.isCentreLoggedIn = false;
          ...
          /*  $scope.forgetPassOrUnlockPassChangeEvent = function(){
           ...
           $scope.centreLogin = function() {
				...
				AuthenticationService.centreLogin($scope.centre_userName, $scope.centre_password, $scope.selectedUserRole, function(result){								
						if(result === 1){
