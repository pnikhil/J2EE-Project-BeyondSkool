...
public class DataImportException extends Exception {
		...
		public DataImportException(int errorCode) {
			this.errorCode = errorCode;
		}

		public DataImportException(String errorText) {
			this.errorText = errorText;
		}

		public DataImportException(Throwable rootCause) {
			this.rootCause = rootCause;
		}
		
		public DataImportException(int errorCode, String errorText) {
			this.errorCode = errorCode;
			this.errorText = errorText;
		}

		public DataImportException(int errorCode, Throwable rootCause) {
			this.errorCode = errorCode;
			this.rootCause = rootCause;
		}

		public DataImportException(int errorCode, String errorText, Throwable rootCause) {
			this.errorCode = errorCode;
			this.errorText = errorText;
			this.rootCause = rootCause;
		...
		public DataImportException(int errorCode, Object[] arguments) {
			this.errorCode = errorCode;
			this.arguments = arguments;
		}

		public DataImportException(int errorCode, Object[] arguments, Throwable rootCause) {
			this.errorCode = errorCode;
			this.arguments = arguments;
			this.rootCause = rootCause;
		}
